...
every coordinate you drew at the 1920x1080 scale. This document is shown live in a smaller \
preview box in the app, and the SVG is also pulled out of it as-is for the standalone .svg \
export -- it must render identically (just scaled) in both places, with nothing visible outside \
the SVG."""
